# Unity(リアルタイム3Dコンテンツ)アバター制作者のためのR3F翻訳ガイド

貴官は「C#ゴリゴリのエンジニア」ではなく「アバター改変・ギミック作成者」であるという前提に基づき、**リアルタイム3Dコンテンツ Editorの操作** に例えて解説し直します。

## 1. Asset Loading: 「Projectに入れてドラッグ」 vs 「Boothから取り寄せ」

### Unity (リアルタイム3Dコンテンツ) の感覚
...
リアルタイム3Dコンテンツでアクセサリの位置調整をする時、**「Armature (Bone)」の下に衣服のPrefabを入れ子**にしますよね？

  ...
  return (
    ...
    "text-white font-mono")}>
      ...
      "flex flex-col justify-between p-6 md:p-12")}>
        ...
        <header className={cn("pointer-events-auto flex justify-between",
        "items-start")}>
          <div>
            <h1 className={cn("text-2xl md:text-4xl font-bold",
        ...
        <footer className={cn("pointer-events-auto")}>
          <div className={cn("flex flex-col md:flex-row gap-4 items-center",
          ...
          "border border-white/10")}>
            ...
            <div className={cn("flex gap-4")}>
              <button className={cn("px-6 py-2 bg-white/5",

    ...
    <div className="relative w-full h-screen bg-black text-white font-mono">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-between p-6 md:p-12">
        ...
        <header className="pointer-events-auto flex justify-between items-start">
          <div>
            <h1 className="text-2xl md:text-4xl font-bold tracking-widest border-b-2 border-cyan-500 pb-2 inline-block">
              PROJECT:LAST STAND
            </h1>
            <p className="mt-2 text-xs md:text-sm text-cyan-500/80">
        ...
        <footer className="pointer-events-auto">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-black/40 backdrop-blur-md p-4 rounded-lg border border-white/10">
            {/* 座標情報 (飾り) */}
            ...
            <div className="flex gap-4">
              <button className="px-6 py-2 bg-white/5 hover:bg-cyan-500/20 text-cyan-200 border border-white/10 hover:border-cyan-500/50 rounded transition-all active:scale-95">
